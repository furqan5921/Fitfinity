  ...
  return (
    <>
      ...
      <Container maxW="100%" h="auto" bg="white" pb="100px">
        ...
        >
          Fitfinity is the most accurate, comprehensive nutrition tracking app
        ...
        <Text
          ...
          fontSize={["md","md","lg","lg"]}
        >
          Our CEO, Aaron Davidson, built Fitfinity as a side project in 2005. He
          ...
          decided to build an app to track his diet. Thus, Fitfinity was born.
        ...
        <Text
          ...
          fontSize={["md","md","lg","lg"]}
        >
          Fitfinity's success has hinged entirely on positive word-of-mouth from
