  ...
  return (
    <Box w="95%" m="auto" bg="white" borderRadius={"10px"} p="10px">
      ...
      <Accordion defaultIndex={[0]} allowMultiple>
        <AccordionItem>
          <AccordionButton>
            <Box color={"#005c5c"} as="b" flex="1" textAlign="left">
          ...
          <AccordionPanel pb={4}>
            ...
            <br />
            <Text fontWeight={"600"}>Basic (free version):</Text>
            <Text>
            ...
            <br />
            <Text fontWeight={"600"}>Enterprise:</Text>
            <Text>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            ...
            <Text>You can learn more on security at Cronometer here.</Text>
          </AccordionPanel>
        </AccordionItem>
